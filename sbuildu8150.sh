...
make -j3 cm9_u8150_alberto96_defconfig
...
./mkbootfs u8150 | gzip > ramdisk.gz
...
./mkbootimg --cmdline 'mem=211M console=ttyMSM2,115200n8 androidboot.hardware=u8150' --kernel zImage --ramdisk ramdisk.gz --base 0x00200000 --ramdiskaddr 0x01200000 -o boot.img
